...
namespace {
    ...
    if (!function_exists('password_hash')) {
        ...
        function password_hash($password, $algo, array $options = array())
        {
            ...
            if (isset($options['salt'])) {
                ...
                if (function_exists('mcrypt_create_iv') && !defined('PHALANGER')) {
                    $buffer = call_user_func_array('mcrypt_create_iv', array($raw_salt_len, MCRYPT_DEV_URANDOM));
                    if ($buffer) {
                        $buffer_valid = true;
                    }
                }
            ...
            if ($salt_requires_encoding) {
                ...
                $base64_string = call_user_func('base64_encode', $salt);
        ...
        function _strlen($binary_string)
        {
            ...
            return \Tools::strlen($binary_string);
        }
        ...
        function _substr($binary_string, $start, $length)
        {
            ...
            return \Tools::strlen($binary_string, $start, $length);
        }
