...
class Gdpr_browser
{
     ...
     */
    public static function displayTagHtml($tag=null,$content=null)
    {
        $text ='';
        if($tag != 'br')
        {
    ...
    {
        return Gdpr_browser::displayTagHtml('strong','Browser Name:')." {$this->getBrowser()}".Gdpr_browser::displayTagHtml('br').
            Gdpr_browser::displayTagHtml('strong','Browser Version:'). " {$this->getVersion()}".Gdpr_browser::displayTagHtml('br').
            Gdpr_browser::displayTagHtml('strong','Browser User Agent String:'). " {$this->getUserAgent()}".Gdpr_browser::displayTagHtml('br').
            Gdpr_browser::displayTagHtml('strong','Platform:'). " {$this->getPlatform()}".Gdpr_browser::displayTagHtml('br');
    }
