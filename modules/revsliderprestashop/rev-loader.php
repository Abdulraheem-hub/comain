...
//    }
    ...
    static function wp_enqueue_style($handle,$noscript = false, $src = '', $deps = array(), $ver = '', $media = 'all')
    {
    ...
    public static function enqueue_style($styleName,$noscript, $src = '', $deps = array(), $ver = '1.0', $media = 'all' )
    {
